...
const NavBar = () => {
  ...
  return (
    <>
      <div className="navbar border-b border-[color:var(--border)] bg-[color:var(--surface)]/90 px-4 py-3 text-[color:var(--text)] shadow-sm backdrop-blur md:px-6">
        <div className="flex-1">
         {user ? (
            <Link to="/" className="btn btn-primary text-lg font-semibold tracking-wide">
              <FontAwesomeIcon icon={faTree} />
              <span>Dev Tinder</span>
            </Link>
          ) : (
            <button className="btn btn-primary text-lg font-semibold tracking-wide">
              <FontAwesomeIcon icon={faTree} />
              <span>Dev Tinder</span>
            </button>
          )}
        ...
        <div className="flex items-center gap-3">
          {user && (
            <Link
              to="/viewprofile"
              className="flex items-center gap-2 rounded-2xl bg-[color:var(--brand)] px-4 py-2 text-[color:var(--cream)] shadow-sm transition hover:bg-[color:var(--brand-dark)]"
            > <span>
          ...
          <label
            className={`flex h-10 w-10 items-center justify-center rounded-full border border-[color:var(--border)] bg-[color:var(--surface-2)] text-[color:var(--brand)] shadow-sm transition-all duration-200`}
          >
            <input
              type="checkbox"
          ...
          {user && (
            <div className="dropdown dropdown-end">
              ...
              <ul
                tabIndex="-1"
                className="menu menu-sm dropdown-content rounded-box z-1 mt-3 w-56 border border-[color:var(--border)] bg-[color:var(--surface)] p-2 shadow-lg"
              >
                <li>
